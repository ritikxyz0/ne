...
def authorize_user(message, func):
    ...
    if is_key_valid(message.text):
        ...
        bot.reply_to(message, "🚫KEY EXPIRED OR INVALID❌ GET NEW KEY 🔑 @Ritikxyz099✅.")    
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"𝐊𝐈𝐍𝐆 𝐎𝐅 𝐃𝐃𝐎𝐒 𝐁𝐎𝐓\n\n@Ritikxyz099,𝐒𝐓𝐀𝐑𝐓𝐄𝐃 𝐘𝐎𝐔𝐑 𝐀𝐓𝐓𝐀𝐂𝐊\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} Seconds\n𝐌𝐞𝐭𝐡𝐨𝐝: BGMI"
    bot.reply_to(message, response)
...
Official Channel :- https://t.me/Ritikakki
'''
